...
<div class="content-wrapper taxonomy-archive">
	...
	if ( have_posts() ) {
		...
		<div class="no-posts-found">
			<h2><?php esc_html_e( 'No Books Found by This Author', 'bookstore-theme' ); ?></h2>
			<p><?php esc_html_e( 'Sorry, but there are no books available by this author.', 'bookstore-theme' ); ?></p>
		</div>
		<?php
	}
	?>
